...
public class LogTimeAssertionHelperTests
{
    ...
    {
        // Arrange
        string logMessage = "Handled TestRequest in 600 ms";
    ...
    public Task ContainsExpectedTime_Should_Fail_When_Time_Outside_Percentage()
    {
        ...
        // Act & Assert
        Should.Throw<System.Exception>(() => LogTimeAssertionHelper.ContainsExpectedTime(logMessage, expectedTime, percent));
        return Task.CompletedTask;
    }
    ...
    {
        // Arrange
        string logMessage = "Handled TestRequest in abc ms"; // Invalid time
        long expectedTime = 600;
        double percent = 10; // 10% tolerance
    ...
    {
        // Arrange
        string logMessage = "Handled TestRequest in 600 seconds"; // Different unit
        long expectedTime = 600;
        double percent = 10; // 10% tolerance
        
        // Act & Assert
        Should.Throw<System.Exception>(() => LogTimeAssertionHelper.ContainsExpectedTime(logMessage, expectedTime, percent, "ms"));
        return Task.CompletedTask;
    }
}